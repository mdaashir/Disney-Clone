...
interface AppStore {
  // Theme state
  theme: Theme["mode"];
  setTheme: (_theme: Theme["mode"]) => void;
  ...
  setSearchFilters: (_filters: Partial<SearchFilters>) => void;
  clearSearch: () => void;

  // Watchlist state
  watchlist: number[];
  addToWatchlist: (_movieId: number) => void;
  removeFromWatchlist: (_movieId: number) => void;
  isInWatchlist: (_movieId: number) => boolean;

  // Favorites state
  favorites: number[];
  addToFavorites: (_movieId: number) => void;
  removeFromFavorites: (_movieId: number) => void;
  isInFavorites: (_movieId: number) => boolean;
...
export const useSearchFilters = () =>
  useAppStore((state) => state.searchFilters);
